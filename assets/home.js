...
var targetX=0,targetY=0,currentX=0,currentY=0,spin=0,last=performance.now();
function move(e){var r=stage.getBoundingClientRect();targetX=((e.clientX-r.left)/r.width-.5)*18;targetY=((e.clientY-r.top)/r.height-.5)*-12;}
